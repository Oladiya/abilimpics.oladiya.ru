            ...
            <div class="col-auto mb-3">
                <div class="card border-warning" style="width: 20rem;">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('orders.update', $order->id) }}" class="btn btn-primary"
                           onclick="event.preventDefault();
                       document.getElementById('update-order-form{{$order->id}}').submit();">
                            Изменить</a>

                        <form id="update-order-form{{$order->id}}" method="POST" action="{{ route('orders.update', $order->id) }}" class="d-none">
                            @method('PUT')
                            @csrf
                        </form>
